...
class Deciliter
  ...
  def self.to_teaspoon(deciliter, po)
    if deciliter < 0
      deciliter * 100 / -5.0
  ...
  def self.to_tablespoon(deciliter, po)
    if deciliter < 0
      deciliter * 100 / -18.0
  ...
  def self.to_liter(deciliter, po)
    if deciliter < 0
  ...
  def self.to_glass(deciliter, po)
    if deciliter < 0
      deciliter * 100 / -200.0
