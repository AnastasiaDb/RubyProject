...
class GlassTest < Minitest::Test
  def test_glass_to_kilo
    ...
    assert_equal 1.0, ::Converter.glassTOkilo(-5)
  ...
  def test_glass_to_gram
    ...
    assert_equal 1000.0, ::Converter.glassTOgram(-5)
  ...
  def test_glass_to_ml
    ...
    assert_equal 1000.0, ::Converter.glassTOml(-5)
  ...
  def test_glass_to_teaspoon
    ...
    assert_equal 200.0, ::Converter.glassTOteaspoon(-5)
  ...
  def test_glass_to_liter
    ...
    assert_equal 1.0, ::Converter.glassTOliter(-5)
  ...
  def test_glass_to_diciliter
    ...
    assert_equal 10.0, ::Converter.glassTOdeciliter(-5)
